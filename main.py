...
if __name__ == '__main__':
    ...
    parser.add_argument('--interactivebr-dividends', dest='dividends_interactivebr',help='The path to an excel file detailing Interactive Broker transactions.')
    ...
    if args.dividends_interactivebr:
       InteractiveBrokersDividendsImporter.import_dividends(payments, args.dividends_interactivebr)
